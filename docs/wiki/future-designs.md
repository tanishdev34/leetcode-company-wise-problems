...
| [`2026-06-09-ai-roadmap-planner-design.md`](../superpowers/specs/2026-06-09-ai-roadmap-planner-design.md) | Current roadmap direction: user gives a natural-language goal, AI creates the full schedule, pacing, strategy, and exact question assignments. | Follow [`2026-06-09-ai-roadmap-planner-implementation.md`](../superpowers/plans/2026-06-09-ai-roadmap-planner-implementation.md). Supersedes the manual questions-per-day/study-days flow in `2026-06-08-roadmap-planner-design.md`. |
| [`2026-06-08-roadmap-planner-design.md`](../superpowers/specs/2026-06-08-roadmap-planner-design.md) | Historical first roadmap concept. | Superseded. Do not implement the manual questions-per-day/study-days creation flow. |
